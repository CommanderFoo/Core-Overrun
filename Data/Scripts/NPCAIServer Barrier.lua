...
local move_down = ROOT:GetCustomProperty("move_down")
local destroy_it = ROOT:GetCustomProperty("destroy_it")
local disable_it = ROOT:GetCustomProperty("disable_it")
local debug_state = ROOT:GetCustomProperty("debug_state")
